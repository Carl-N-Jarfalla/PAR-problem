...
%\input{uppgifter/arbetskopia.tex} %Ändra till den uppgift som ska byggas

\input{uppgifter/ma2/hundrametersloppet.tex}

\input{uppgifter/ma2/En linjes egenskaper.tex} 

\input{uppgifter/ma2/tre punkter.tex}

\input{uppgifter/ma2/Lösa ekvationssystem.tex}

\input{uppgifter/ma2/system av vektorer.tex} 

\input{uppgifter/ma2/Sangaku.tex} 

\input{uppgifter/ma2/Parallella linjer i en parabel.tex}

\input{uppgifter/ma2/kvadrater i kvadrat.tex}

\input{uppgifter/ma2/vertex.tex} 

\input{uppgifter/ma2/Vinklar vid parallella linjer.tex} 

\input{uppgifter/ma2/glasspaketet.tex} 
%-------------------------------------------------------------------
